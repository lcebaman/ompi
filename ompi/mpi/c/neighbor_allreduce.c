...
#pragma weak MPI_Neighbor_allreduce = PMPI_Neighbor_allreduce
#endif
#define MPI_Neighbor_allreduce PMPI_Neighbor_allreduce
#endif

static const char FUNC_NAME[] = "MPI_Neighbor_allreduce";


int MPI_Neighbor_allreduce(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                           ...
                           MPI_Comm comm)
{
    ...
    SPC_RECORD(OMPI_SPC_NEIGHBOR_ALLREDUCE, 1);
    ...
    /* TODO:*/
    /* err = comm->c_coll->coll_neighbor_allreduce(sendbuf, sendcount, sendtype, recvbuf, */
    /*                                           recvcount, recvtype, comm, */
    /*                                           comm->c_coll->coll_neighbor_allreduce_module); */
